function create()
    ...
    self:makeCharacterAnim('singLEFTmiss', 'BF LEFT MISS', nil, 24, false, {0, 0})
    self:makeCharacterAnim('singDOWNmiss', 'BF DOWN MISS', nil, 24, false, {0, 0})
    self:makeCharacterAnim('singUPmiss', 'BF UP MISS', nil, 24, false, {0, 0})
    self:makeCharacterAnim('singRIGHTmiss', 'BF RIGHT MISS', nil, 24, false, {0, 0})
