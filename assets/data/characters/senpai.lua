function create()
    ...
    self:makeCharacterAnim('singRIGHT', 'SENPAI RIGHT NOTE', nil, 24, false,
                           {0, 0})
    self:makeCharacterAnim('singLEFT', 'SENPAI LEFT NOTE', nil, 24, false,
                           {40, 0})
    self:makeCharacterAnim('singDOWN', 'SENPAI DOWN NOTE', nil, 24, false,
                           {14, 0})
