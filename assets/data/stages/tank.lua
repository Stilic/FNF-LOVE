...
function create()
    ...
    bg:load(paths.getImage(SCRIPT_PATH .. 'tankSky'))
    bg:setScrollFactor()
    self:add(bg)

    local tankMountains = Sprite(-300, -20)
    tankMountains:load(paths.getImage(SCRIPT_PATH .. 'tankMountains'))
    ...
    tankBuildings:load(paths.getImage(SCRIPT_PATH .. 'tankBuildings'))
    ...
    tankRuins:load(paths.getImage(SCRIPT_PATH .. 'tankRuins'))
