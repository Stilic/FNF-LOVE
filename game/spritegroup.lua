...
local function tranformChildren(self, func, value)
    ...
    for i, sprite in pairs(self.__sprites) do
...
function SpriteGroup:load(texture, width, height) return self end

function SpriteGroup:setFrames(frames) return self.__frames end
