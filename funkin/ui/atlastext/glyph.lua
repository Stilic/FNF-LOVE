...
function Glyph:__render(camera)
	...
	if self.__lastFrame ~= math.floor(self.animation.curAnim.frame or 0) or self.__forceUpdate then
		...
		self.__lastFrame = math.floor(self.animation.curAnim.frame or 0)
